...
- 当前前端与云服务 release：`20260912_22ab00f`；上一版本均为 `20260912_5018e4d`。v20 进度换算、备份、云校验同步及回滚边界见[v20 发布记录](releases/2026-09-12-save-v20.md)。旧版记录见[经验修正](releases/2026-09-11-experience-shop-style.md)和[蛋蛋商城](releases/2026-09-11-eggs-shop.md)。数据库不随 release 回滚。
