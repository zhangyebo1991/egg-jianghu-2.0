...
- 当前前端与云服务 release：`20260911_b778c15`；上一版本均为 `20260911_eggs_38e0536`。本次经验修正、商城／设置样式及云校验同步见[发布记录](releases/2026-09-11-experience-shop-style.md)。新增蛋蛋与周月卡字段的历史记录见[蛋蛋商城发布记录](releases/2026-09-11-eggs-shop.md)。数据库不随 release 回滚。
